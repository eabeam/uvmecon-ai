...
\small We're \textbf{not} posting the full recording publicly --- but skills, etc. will be posted on https://thinkingwithagents.github.io/
\end{tcolorbox}
\end{column}
\begin{column}{0.48\textwidth}
...
\end{tcolorbox}
\end{column}
% AI note: can you vertically center the figure
...
\item \textit{Even better: make it a repo for version control, save data outside}
\end{itemize}
\end{tcolorbox}
\end{column}
\end{columns}
...
\end{column}
\begin{column}{0.46\textwidth}
%AI note: Replace this with a list of resources (Paul Goldsmith-Pinkham: Video series, Aniket Panjwani, Chris Blattman, Scott Cunningham, etc. (do research and fill this in properly) ) 
\begin{tcolorbox}[colback=PaleSage, colframe=SlateTeal!40, boxrule=0.5pt, left=5pt, right=5pt, top=3pt, bottom=3pt]
\scriptsize
\textbf{Other great resource}
\begin{itemize}\setlength{\itemsep}{1pt}
