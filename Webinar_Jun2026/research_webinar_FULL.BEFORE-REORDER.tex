...
\begin{itemize}\setlength{\itemsep}{3pt}
  \item \textbf{Foundations:} Getting to know each other
...
\includegraphics[width=\textwidth, height=0.30\textheight, keepaspectratio]{desktop-claude.png}\\[1pt]
{\scriptsize\color{CoolGray} Claude desktop app}
\end{column}
\begin{column}{0.40\textwidth}\centering
\includegraphics[width=\textwidth, height=0.30\textheight, keepaspectratio]{desktop-codex.png}\\[1pt]
...
%% ---- Framing: prompt -> build -> cite ----
\begin{frame}{The whole hour, in three moves}
\vskip6pt
\begin{columns}[T,onlytextwidth]
\begin{column}{0.30\textwidth}
\begin{tcolorbox}[keybox, title={\faComments\quad 1. Prompt \& converse}, top=3pt, bottom=3pt]
\small You \textbf{direct} it in plain language --- back-and-forth, not one shot. You stay in charge.
\end{tcolorbox}
\end{column}
\begin{column}{0.04\textwidth}
\centering\vskip1.0cm{\large\color{UVMGold}\faArrowRight}
\end{column}
\begin{column}{0.30\textwidth}
\begin{tcolorbox}[keybox, title={\faHammer\quad 2. Build}, top=3pt, bottom=3pt]
\small \textbf{It} builds the thing --- you build nothing. A cleaned file, a table, a whole repo.
\end{tcolorbox}
\end{column}
\begin{column}{0.04\textwidth}
\centering\vskip1.0cm{\large\color{UVMGold}\faArrowRight}
\end{column}
\begin{column}{0.30\textwidth}
\begin{tcolorbox}[keybox, title={\faHistory\quad 3. Recall}, top=3pt, bottom=3pt]
\small Next session, \textbf{pull that context back up} and keep going --- from logs, hubs, a handoff file.
\end{tcolorbox}
\end{column}
\end{columns}
\vskip8pt
\begin{tcolorbox}[accentbox, halign=center, top=3pt, bottom=3pt]
\small Everything I show you today is one of these three.
\end{tcolorbox}
\end{frame}
...
\begin{frame}[fragile]{From a prompt, to a skill, to an artifact}
\vskip4pt
\begin{columns}[T,onlytextwidth]
\begin{column}{0.30\textwidth}
\begin{tcolorbox}[keybox, title={\faAlignLeft\quad Reusable prompt}, top=3pt, bottom=3pt]
\small A chunk of instructions you \textbf{keep and re-paste}. Your starting point.
\end{tcolorbox}
\end{column}
\begin{column}{0.04\textwidth}
\centering\vskip0.9cm{\large\color{UVMGold}\faArrowRight}
\end{column}
\begin{column}{0.30\textwidth}
\begin{tcolorbox}[keybox, title={\faMagic\quad Skill}, top=3pt, bottom=3pt]
\small That prompt \textbf{grown up}: packaged steps, invoked by name (\texttt{/econ-audit}), shareable.
\end{tcolorbox}
\end{column}
\begin{column}{0.04\textwidth}
\centering\vskip0.9cm{\large\color{UVMGold}\faArrowRight}
\end{column}
\begin{column}{0.30\textwidth}
\begin{tcolorbox}[keybox, title={\faFile\quad Artifact}, top=3pt, bottom=3pt]
\small What it \textbf{produces}: a cleaned file, a table, a repo, a memo.
\end{tcolorbox}
\end{column}
\end{columns}
\vskip8pt
\begin{tcolorbox}[coralbox, title={\faExclamationCircle\quad We have some skills you can use, and they are fine.}, top=3pt, bottom=3pt]
\small A skill is just \textbf{a series of actions, packaged} --- a shortcut, not a product. Ours aren't special. Take them as a \textbf{template and build your own}.
\end{tcolorbox}
\end{frame}
%
...
%% AI NOTE - can you add the other voice-file demo slides from the earleir bootcamp in here.
