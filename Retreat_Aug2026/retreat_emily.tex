...
%% ====== SLIDE: FOUR GRADERS, ONE REAL PROPOSAL ======
\begin{frame}{Four graders, one real proposal}
\vskip-6pt
{\footnotesize A real S26 submission, de-identified, mid-distribution. My actual rubric and prompt, all four blind.\par}
\vskip1pt
\begin{columns}[T]
\begin{column}{0.56\textwidth}
{\scriptsize
\setlength{\tabcolsep}{3pt}\renewcommand{\arraystretch}{0.98}
\begin{tabular}{>{\raggedright\arraybackslash}m{3.0cm} c c c c c}
\rowcolor{SlateTeal}
\textcolor{white}{\textbf{Criterion (pts)}} & \textcolor{white}{\textbf{Me}} & \textcolor{white}{\textbf{Copilot}} & \textcolor{white}{\textbf{Sonnet}} & \textcolor{white}{\textbf{Opus}} & \textcolor{white}{\textbf{Fable}} \\
\rowcolor{white}     Research question (2) & 2 & 2 & 2 & 1.5 & 2 \\
\rowcolor{PaleSage}  Motivation (4) & 4 & 4 & 3 & 3 & 3 \\
\rowcolor{white}     Literature (4) & 3 & 3 & 2 & 3 & 2 \\
\rowcolor{PaleSage}  Data identification (2) & 2 & 2 & 2 & 1.5 & 2 \\
\rowcolor{white}     Summary stats table (4) & 3 & 2 & 3 & 2 & 2 \\
\rowcolor{PaleSage}  Specification (4) & 3 & 3 & 3 & 3 & 3 \\
\rowcolor{LightGold} Critical thinking (4) & \textbf{4} & \textbf{4} & 3 & \textbf{2} & \textbf{2} \\
\rowcolor{white}     Qualified assertions (2) & 1 & 2 & 1.5 & 1.5 & 2 \\
\rowcolor{PaleSage}  Threats (2) & 1 & 2 & 1.5 & 1.5 & 1.5 \\
\rowcolor{white}     Bibliography (2) & 1.5 & 2 & 1.5 & 1.5 & 1 \\
\rowcolor{PaleSage}  Formatting (4) & 4 & 4 & 4 & 4 & 4 \\
\rowcolor{white}     Writing quality (4) & 3.5 & 4 & 3 & 3 & 3 \\
\rowcolor{LightGold} \textbf{Total (38)} & \textbf{32} & \textbf{34} & \textbf{29.5} & \textbf{27.5} & \textbf{27.5} \\
\rowcolor{white}     Flagged for a check-in? & no & no & no & \textbf{yes} & \textbf{yes} \\
\end{tabular}
}
\end{column}
\begin{column}{0.42\textwidth}
...
\scriptsize
\begin{itemize}\setlength{\itemsep}{3pt}
  \item \textbf{6.5 points of spread} on one paper, one rubric --- and it \emph{straddles} me. This isn't ``AI grades low.''
  \item \textbf{Critical thinking ran 2 to 4.} The judgment criterion, exactly where you'd expect it.
  \item \textbf{Opus and Fable both landed on 27.5} while disagreeing on five of twelve. Same total is not agreement.
  \item \textbf{Two of the four flagged this student} for a check-in. I hadn't.
\end{itemize}
\end{tcolorbox}
\vskip3pt
\begin{tcolorbox}[quotebox, top=1pt, bottom=1pt]
\scriptsize \textbf{How I know these mean anything:} I ran this identical setup first on a paper \emph{I wrote} --- 14 planted flaws, answer key written before anyone graded. There, every grader came in \emph{above} my key. Here, three of four came in \emph{below} me.
\end{tcolorbox}
\end{column}
\end{columns}
\end{frame}
