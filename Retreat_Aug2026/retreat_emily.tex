...
%% ====== SLIDE: SUMMARY ======
\begin{frame}{What I'd actually tell you to do}
\vskip-2pt
\begin{columns}[T]
\begin{column}{0.32\textwidth}
...
\begin{itemize}\setlength{\itemsep}{3pt}
  ...
  \item \textbf{One job per pass}, and let them disagree --- the disagreements are the product.
  \item \textbf{De-identify first.} Mine never sees a name, which is what lets me use whatever model grades best.
\end{itemize}
\end{tcolorbox}
\end{column}
\begin{column}{0.32\textwidth}
...
\scriptsize
\begin{itemize}\setlength{\itemsep}{3pt}
  \item \textbf{It drifts} --- always on the judgment lines. Up on a paper built to be middling; \emph{down} on a real one. Check which way yours goes.
  \item \textbf{One pass is never enough.} Budget the second one.
...
\begin{itemize}\setlength{\itemsep}{3pt}
  ...
  \item \textbf{At 21 submissions it wasn't clearly faster.} It was more consistent.
\end{itemize}
\end{tcolorbox}
\end{column}
\end{columns}
